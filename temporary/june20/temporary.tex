...
\begin{proof}
Let $P' = WP(Q;havoc(x))$ and $Q'=SP(P;havoc(x))$. It is obvious that $P$ can also be written as $WP(Q;x:=t)$ and $Q$ as $SP(P;x:=t)$.\\
"$\Rightarrow$"\\
