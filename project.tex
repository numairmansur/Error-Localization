...
\subsubsection*{Proof:}
Consider first a case where we have an error trace $\pi$ of length 2, containing one havoc statement and one assume statement. Let $guard(x)$ be the guard of the assume statement. 
